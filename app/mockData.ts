...
export const initialClients: Client[] = [
  {
    ...
    subitems: [
      {
        id: 's1', name: 'Book', people: '', status: '', qty: '50', description: 'NB 2498-II except BK no s...', remarks:'', shipper:'', supplier: 'SG Supplier A', cost: '3.9', m: '30', ls: '', os: '90', tc: '184.935', uc: '3.699', tcSgd: '64.935', price: '445', up: '8.9', cnTracking:'', sgTracking:'',
        owner: '', paymentStatus: '', total: '445', manpower: '0', lsRmb: '0', totalC: '445', modeOfPayment: '', orderNumber: '', quantityProduced: '', sample: '', qtyFor: '', paymentAmount: '', difference: '', paymentPr: '',
      ...
      },
      {
        ...
        owner: '', shipper: '', paymentStatus: 'Paid', total: '400', manpower: '0', lsRmb: '0', totalC: '400', modeOfPayment: 'AliPay', orderNumber: '31729283810524', quantityProduced: '50', sample: '0', qtyFor: '50', paymentAmount: '400', difference: '0', paymentPr: '',
      ...
      },
      {
        ...
        owner: '', shipper: '', paymentStatus: '', total: '475', lsRmb: '0', totalC: '475', modeOfPayment: '', orderNumber: '', quantityProduced: '', sample: '', qtyFor: '', paymentAmount: '', difference: '', paymentPr: '',
        timelineRows: makeTimelineRows(), showTimeline: false, showPayments: false,sampleRows:[], showSample: false, sampleOrderStatus:'', sampleStatus:'', sampleType:'',remarks:'',
      },
      {
        ...
        owner: '', shipper: '', paymentStatus: '', total: '400', lsRmb: '0', totalC: '400', modeOfPayment: '', orderNumber: '', quantityProduced: '', sample: '', qtyFor: '', paymentAmount: '', difference: '', paymentPr: '',
        timelineRows: makeTimelineRows(), showTimeline: false, showPayments: false,sampleRows:[], showSample: false, sampleOrderStatus:'', sampleStatus:'', sampleType:'',remarks:'',
      },
    ],
  },
    ...
    subitems: [
      {
        ...
        owner: 'A5', shipper: 'DHL', paymentStatus: 'Paid', total: '800', manpower: '0', lsRmb: '0', totalC: '800', modeOfPayment: 'AliPay', orderNumber: '3294585660109524550', quantityProduced: '100', sample: '0', qtyFor: '100', paymentAmount: '800', difference: '0', paymentPr: '',
        timelineRows: makeTimelineRows(), showTimeline: false, showPayments: false, sampleRows:[], showSample: false, sampleOrderStatus:'', sampleStatus:'', sampleType:'',remarks:'',
      },
    ],
  },
  {
    ...
    requirements: 'Premium notebooks with branding', qty: '450', nbd: 'Jan 19, 2026', totalPrice: '6,370', companyAddress:'', billingAddress:'',
    ...
    subitems: [
      {
        ...
        owner: '小字', shipper: 'Sea Freight', paymentStatus: 'Paid', total: '4800', manpower: '44', lsRmb: '220', totalC: '5020', modeOfPayment: '1688', orderNumber: '3171292932810524550', quantityProduced: '300', sample: '0', qtyFor: '300', paymentAmount: '5020', difference: '0', paymentPr: '',
        timelineRows: makeTimelineRows(), showTimeline: false, showPayments: false, sampleRows:[], showSample: false, sampleOrderStatus:'', sampleStatus:'', sampleType:'',remarks:'',
      },
      {
        ...
        owner: '小字', shipper: 'Sea Freight', paymentStatus: 'Paid', total: '1260', manpower: '18', lsRmb: '90', totalC: '1350', modeOfPayment: '1688', orderNumber: '3194717232304524550', quantityProduced: '150', sample: '0', qtyFor: '150', paymentAmount: '1350', difference: '0', paymentPr: '',
        timelineRows: makeTimelineRows(), showTimeline: false, showPayments: false, sampleRows:[], showSample: false, sampleOrderStatus:'', sampleStatus:'', sampleType:'',remarks:'',
      },
    ],
  },
  {
    ...
    requirements: 'Towel customization with full colour print', qty: '500', nbd: 'Jun 15, 2024', companyAddress:'', billingAddress:'',
    totalPrice: '', expanded: false, color: '#24819c',
    subitems: [
      {
        id: 's8', name: 'Towel (Set of 7)', people: 'XH', status: '', qty: '500', remarks: 'Full colour sublimation', supplier: 'CN Towel Factory', cost: '4.2', m: '', ls: '', os: '', tc: '', uc: '', tcSgd: '', price: '', up: '', cnTracking:'', sgTracking:'',
        owner: '', shipper: '', paymentStatus: '', total: '', manpower: '', lsRmb: '', totalC: '', modeOfPayment: '', orderNumber: '', quantityProduced: '', sample: '', qtyFor: '', paymentAmount: '', difference: '', paymentPr: '',
        timelineRows: [
  ...
  },
  {
    ...
    requirements: 'Custom pen sets with company logo', qty: '200', nbd: '', companyAddress:'', billingAddress:'', 
    totalPrice: '', expanded: false, color: '#008e9b',
    subitems: [
      {
        id: 's9', name: 'Custom Pen Set (Box of 3)', people: '', status: 'Pending', qty: '200', description: 'Logo on clip, 1 colour', supplier: '', cost: '2.5', m: '', ls: '', os: '', tc: '', uc: '', tcSgd: '', price: '', up: '', cnTracking:'', sgTracking:'',
        owner: '', shipper: '', paymentStatus: '', total: '', manpower: '', lsRmb: '', totalC: '', modeOfPayment: '', orderNumber: '', quantityProduced: '', sample: '', qtyFor: '', paymentAmount: '', difference: '', paymentPr: '',
        timelineRows: makeTimelineRows(), showTimeline: false, showPayments: false,sampleRows:[], showSample: false, sampleOrderStatus:'', sampleStatus:'', sampleType:'',remarks:'',
      },
    ],
  ...
  },
  {
    ...
    requirements: 'Corporate gifts for AGM - 500 pax', qty: '500', nbd: 'Aug 15',
    totalPrice: '4,500', expanded: false, color: '#4e8397',
    subitems: [
      {
        id: 's10', name: 'Leather Portfolio', people: 'JM', status: 'In Progress', qty: '500', description: 'Deboss logo, tan leather', supplier: 'CN Leather Co.', cost: '7.5', m: '20', ls: '', os: '90', tc: '420', uc: '8.4', tcSgd: '120', price: '3750', up: '7.5', cnTracking:'', sgTracking:'',
        owner: 'JM', shipper: '', paymentStatus: 'To Pay', total: '3750', manpower: '50', lsRmb: '150', totalC: '3900', modeOfPayment: '', orderNumber: '', quantityProduced: '', sample: '5', qtyFor: '500', paymentAmount: '', difference: '', paymentPr: '',
        timelineRows: makeTimelineRows(), showTimeline: false, showPayments: false,sampleRows:[], showSample: false, sampleOrderStatus:'', sampleStatus:'', sampleType:'',remarks:'',
      },
      {
        id: 's11', name: 'Metal Pen', people: '', status: 'Pending', qty: '500', description: 'Laser engrave logo', supplier: '', cost: '1.5', m: '', ls: '', os: '', tc: '', uc: '', tcSgd: '', price: '750', up: '1.5', cnTracking:'', sgTracking:'',
        owner: '', shipper: '', paymentStatus: '', total: '750', manpower: '', lsRmb: '', totalC: '', modeOfPayment: '', orderNumber: '', quantityProduced: '', sample: '', qtyFor: '', paymentAmount: '', difference: '', paymentPr: '',
        timelineRows: makeTimelineRows(), showTimeline: false, showPayments: false,sampleRows:[], showSample: false, sampleOrderStatus:'', sampleStatus:'', sampleType:'',remarks:'',
      },
    ],
  },
