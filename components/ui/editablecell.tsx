...
export function EditableCell({
    ...
    return (
        <div
            ...
            title={value}
            className={`w-full px-1 py-0.5 text-xs cursor-text hover:bg-blue-50 rounded min-h-[22px] flex items-center ${multiline ? 'whitespace-nowrap overflow-hidden text-ellipsis' : 'truncate'
                } ${className}`}
        >
